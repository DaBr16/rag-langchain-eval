...
# Initialize the vector store with a more memory-efficient embedding model
embedding_model = OpenAIEmbeddings(model='text-embedding-3-small')
db = Chroma(embedding_function=embedding_model, persist_directory="vectorstores/percentile")
